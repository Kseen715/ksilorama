...
import sys
import fixpath
from ksilorama import AnsiToWin32, init, Fore
...
print('%sUnwrapped CYAN, using the file parameter to write via ksilorama the AnsiToWin32 function.' % Fore.CYAN, file=AnsiToWin32(sys.stdout))
